...
cpu_model=$(echo "$lscpu_out" | egrep "Model name:" | awk '{print $1}' | xargs)
...
stmt="INSERT INTO PUBLIC.host_info (hostname,cpu_number,cpu_architecture,cpu_model,cpu_mhz,L2_cache,total_mem,timestamp)
