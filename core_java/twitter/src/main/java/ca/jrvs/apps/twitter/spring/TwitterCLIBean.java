...
import ca.jrvs.apps.twitter.TwitterAppCLI;
...
public class TwitterCLIBean {
  ...
  public static void main(String[] args) {
    ...
    TwitterAppCLI app = context.getBean(TwitterAppCLI.class);
    app.run(args);
  }

  @Bean
  public TwitterAppCLI twitterAppCLI(Controller controller) {
    return new TwitterAppCLI(controller);
  }
