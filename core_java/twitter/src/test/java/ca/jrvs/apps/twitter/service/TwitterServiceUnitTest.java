...
public class TwitterServiceUnitTest {
  ...
  public void postTweet() {
    ...
    Tweet tweetLat = CreateTweetUtil.createTweet("This is a test", 45, -91);
    try {
    ...
    // long out of range
    Tweet tweetLong = CreateTweetUtil.createTweet("This is a test", 100, 32);
    try {
    ...
    String text = "ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss"
        + "sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss";
    Tweet tweetText = CreateTweetUtil.createTweet(text, 33, 33);
    try {
