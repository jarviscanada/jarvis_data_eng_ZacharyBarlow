...
public class TraderAccountController {
  ...
  @ApiOperation(value = "Deposit a fund",
    notes = "Deposit a fund to the account that associates with the given traderId. Deposit an amount")
  @ApiResponses(value = {
  ...
  @ApiOperation(value = "Withdraw a fund",
      notes = "Withdraw a fund to the account that associates with the given traderId. Withdraw an amount")
  @ApiResponses(value = {
      @ApiResponse(code = 404, message = "traderId is not found"),
